...
const profilePic = "https://firebasestorage.googleapis.com/v0/b/cdred-project.appspot.com/o/pageImgs%2Fprofile.png?alt=media&token=12756539-29a9-4177-bb3b-c81548f4acbd";
        ...
        <ul className="right sidenav" id="mobile-demo">
          <li>
            <div className="user-view">
              ...
              <a href="#user"><img alt="" className="circle" src={authenticated ? credentials.photoURL : profilePic} /></a>
              <a href="#name"><span className="red-text name">{authenticated ? credentials.firstName : "Guest"}</span></a>
            </div>
          </li>
          <li><Link to='/'>Home</Link></li>
          <li><Link to='/cdproject'>Cd Project red</Link></li>
